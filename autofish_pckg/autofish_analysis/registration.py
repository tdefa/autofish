...
### todo add the parameter of compute_euler_transform as kwarg in the function folder_translation
...
def plot_registrered_image(
    ...
    x_translation = dict_translation[pos1][round1][round2]['x_translation']
    y_translation = dict_translation[pos1][round1][round2]['y_translation']
    ...
    shifted_image2 = shifted_image

    return fig, ax, image1, image2, shifted_image2, x_translation, y_translation
