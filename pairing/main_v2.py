...
if __name__ == "__main__":
    ...
    dict_spots_registered_df_with_cell = np.load("/media/tom/Transcend2/autofish/2023-06-28_AutoFISH_22rounds/dict_spots_registered_df_r1_with_cell.npy",
    ...
    path_folder_save_plot = "/media/tom/Transcend2/autofish/2023-06-28_AutoFISH_22rounds/plot_distance_matching/kif1c"
    ...
    fig, ax = plt.subplots(figsize=(16, 10))  # plotting density plot for carat using distplot()
    fig.suptitle(f'percentage of matcg=hed RNA, reference is {ref_round}', fontsize=30, x=0.1, ha='left')
